class Plant{
	...
	/*
	 * You encapsulates the inner working of class
	 * within that class. Don't let anyone from outside of 
	 * class to have access to it if they don't really need it.
	 * Rather use getters and setters for access
	 */
