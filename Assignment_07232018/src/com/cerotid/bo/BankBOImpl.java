...
public class BankBOImpl implements BankBO{
	...
	// We use static block initializer when we have to initialize a complex
	// object as a static member. No so useful in this situation
	...
	public void editCustomerInfo(Customer OldCustomer, Customer newCustomer) {
		...
		OldCustomer.setSsn(newCustomer.getSsn());
	}
